...
function _0x1b46(_0x32347d, _0x5e4165) {
  ...
  return (
    (_0x1b46 = function (_0x1b46bb, _0x194edf) {
...
function _0x122a() {
  const _0x1f4628 = [
    ...
    "10UJuYPM",
    "click",
    ".tp-portfolio-slider-type\x20>\x20.type__item",
    "parentNode",
    ...
    "forEach",
    "set",
    ".slider-nav\x20>\x20.slider-nav__item--next",
    "transform",
    "type__item--current",
    "querySelectorAll",
    "add",
...
(function (_0x334687, _0x2d8861) {
  ...
  while (!![]) {
    try {
      const _0xc58481 =
        -parseInt(_0x235750(0x1a5)) / 0x1 +
        -parseInt(_0x235750(0x1ba)) / 0x2 +
        (parseInt(_0x235750(0x1b8)) / 0x3) *
          (-parseInt(_0x235750(0x1bf)) / 0x4) +
        parseInt(_0x235750(0x1a3)) / 0x5 +
        (-parseInt(_0x235750(0x1ae)) / 0x6) *
          (parseInt(_0x235750(0x1af)) / 0x7) +
        -parseInt(_0x235750(0x1ab)) / 0x8 +
        (parseInt(_0x235750(0x1a6)) / 0x9) * (parseInt(_0x235750(0x1c6)) / 0xa);
...
if (document[_0x6760b6(0x1b5)](_0x6760b6(0x19f))[_0x6760b6(0x1bd)]) {
  class Slider {
    ...
    constructor(_0x57f877, _0x78ad1e = ![]) {
      ...
      ((this[_0xfad059(0x19d)] = _0x57f877),
        ...
        (this["items"] = [
          ...this["element"][_0xfad059(0x1b5)](_0xfad059(0x1ca)),
        ]),
        (this[_0xfad059(0x19e)] = this[_0xfad059(0x1c0)][_0xfad059(0x1cb)](
          (_0xad97a6) => _0xad97a6[_0xfad059(0x1c4)](_0xfad059(0x1b9)),
        )),
        this[_0xfad059(0x1c0)][this["current"]]["classList"][_0xfad059(0x1b6)](
          _0xfad059(0x1b7),
        ),
    ...
    [_0x6760b6(0x1c2)](_0x21ccae) {
      ...
      this["current"] =
        _0x21ccae === 0x1
          ? this["current"] < this["itemsTotal"] - 0x1
            ? ++this[_0x2c43d2(0x1b7)]
            : 0x0
          : this[_0x2c43d2(0x1b7)] > 0x0
            ? --this[_0x2c43d2(0x1b7)]
            : this["itemsTotal"] - 0x1;
      ...
      gsap["timeline"]({
        ...
        onComplete: () => {
          ...
          (this[_0x1449f6(0x1c0)][_0x189e58][_0x1449f6(0x1be)][
            _0x1449f6(0x1a9)
          ]("current"),
            this["items"][this[_0x1449f6(0x1b7)]][_0x1449f6(0x1be)][
              _0x1449f6(0x1b6)
            ](_0x1449f6(0x1b7)),
        ...
        ["to"](_0x59f483, {
          xPercent: this["reverseDirection"]
            ? _0x21ccae * 0x64
            : -_0x21ccae * 0x64,
          onComplete: () => gsap["set"](_0x59f483, { opacity: 0x0 }),
        })
        ["to"](
          _0x4c4658,
          {
            xPercent: this[_0x2c43d2(0x1bb)]
              ? -_0x21ccae * 0x1e
              : _0x21ccae * 0x1e,
            startAt: { rotation: 0x0 },
  ...
  const navigation = {
      ...
      prev: document[_0x6760b6(0x1c4)](
        ".slider-nav\x20>\x20.slider-nav__item--prev",
      ),
      back: document["querySelector"](
        ".slider-nav\x20>\x20.slider-nav__item--back",
      ),
    },
  ...
  (titles[0x0][_0x6760b6(0x1be)]["add"]("type__item--current"),
    titles[_0x6760b6(0x1b0)](
      (_0x5bced2) => (_0x5bced2[_0x6760b6(0x1a0)]["splitting"] = ""),
    ),
    Splitting());
  ...
  gsap["set"]([titles, chars], { "will-change": _0x6760b6(0x1b3) });
  const navigate = (_0x1b2d85) => {
    ...
    toggleTitle = (_0x1889de) => {
      ...
      const _0x24d1be = sliderBG["current"],
        ...
        _0x4659fd =
          _0x1889de === "next"
            ? _0x24d1be < sliderBG[_0x2785a4(0x19c)] - 0x1
              ? _0x24d1be + 0x1
              : 0x0
            : _0x24d1be > 0x0
              ? _0x24d1be - 0x1
              : sliderBG["itemsTotal"] - 0x1,
        _0xf669 = chars[_0x4659fd],
        _0x31372b = 1.1,
        _0x31fbc0 = _0x1889de === _0x2785a4(0x1aa) ? -0x1 : 0x1;
      gsap["timeline"]({
        defaults: { duration: _0x31372b, ease: _0x2785a4(0x1a4) },
        onStart: () => {
        ...
        onComplete: () => {
          ...
          (gsap[_0x154665(0x1b1)](titles[_0x24d1be], { opacity: 0x0 }),
            titles[_0x24d1be][_0x154665(0x1be)]["remove"](_0x154665(0x1b4)));
        },
      })
        [_0x2785a4(0x1b1)](titles[_0x4659fd], { opacity: 0x0 }, 0x0)
        ["to"](titles[_0x24d1be], { xPercent: _0x31fbc0 * 0x28 })
        ["to"](_0x2397d9, { xPercent: _0x31fbc0 * 0x67 }, 0x0)
        ["addLabel"]("in", _0x31372b * 0.15, 0x0)
        [_0x2785a4(0x1b1)](titles[_0x4659fd], { opacity: 0x1 }, "in")
        ["to"](
          titles[_0x4659fd],
          { startAt: { xPercent: _0x31fbc0 * -0x28 }, xPercent: 0x0 },
          "in",
        )
        ["to"](
          _0xf669,
          { startAt: { xPercent: _0x31fbc0 * -0x67 }, xPercent: 0x0 },
          "in",
        );
    };
  (navigation[_0x6760b6(0x1aa)]["addEventListener"](_0x6760b6(0x1c7), () =>
    navigate(_0x6760b6(0x1aa)),
  ),
    navigation[_0x6760b6(0x1bc)][_0x6760b6(0x1ad)]("click", () =>
      navigate("prev"),
    ),
    Observer["create"]({
      target: window,
